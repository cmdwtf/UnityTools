...
namespace cmdwtf.UnityTools.Collections
{
	...
	public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
	{
		...
		bool System.Collections.IList.Contains(object? value)
			=> IsT(value) ? ((ICollection<T>)this).Contains((T)value!) : false;
		...
		private T DoGetItem(int index) => _buffer[DequeIndexToBufferIndex(index)];
		...
		/// <inheritdoc cref="AddToBack"/>
		/// <remarks>As a queue's enqueue.</remarks>
		public void Enqueue(T value) => AddToBack(value);

		/// <inheritdoc cref="AddToBack"/>
		/// <remarks>As a stack's push.</remarks>
		public void Push(T value) => AddToBack(value);

		/// <inheritdoc cref="AddToBack"/>
		/// <remarks>As a list's add.</remarks>
		public void Add(T value) => AddToBack(value);
		...
		/// <inheritdoc cref="RemoveFromFront"/>
		/// <remarks>As a stack's pop.</remarks>
		public T Pop() => RemoveFromFront();
		...
		/// <inheritdoc cref="RemoveFromFront"/>
		/// <remarks>As a queue's dequeue.</remarks>
		public T Dequeue() => RemoveFromFront();
